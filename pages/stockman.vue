<template>
  <div>
    ...
    >
      <template v-slot:top>
        <v-toolbar dark>
          <v-icon>mdi-archive</v-icon>&nbsp;<v-toolbar-title
            >Stock Manager</v-toolbar-title
          >
          <v-toolbar-items>
            <v-btn color="red" text class="elevation-0"
        ...
        <v-toolbar flat color="teal" dark dense>
          <v-row class="pt-4 mt-0" lazy-validation>
            ...
            <v-col cols="1" sm="1" md="1" class="pl-2 ml-0 pr-0 mr-0">
              <v-text-field solo dense light label="LabGram" type="number"></v-text-field>
            </v-col>
            <v-col cols="1" sm="1" md="1" class="pl-2 ml-0 pr-0 mr-0">
              <v-text-field solo dense light label="LabFixed" type="number"></v-text-field>
            </v-col>
            <v-col cols="1" sm="1" md="1" class="pl-2 ml-0 pr-0 mr-0">
              <v-autocomplete
                v-model="value"
            ...
            <v-col cols="2" sm="2" md="2" class="pl-2 ml-0 pr-0 mr-0"> </v-col>
          </v-row>
          <v-spacer></v-spacer>
